namespace MobileTemplate.Core.ViewModels
{
    ...
    public class LoginViewModel : BaseViewModel
    {
        ...
        /// </summary>
        public LoginViewModel(ILoggerFactory logProvider, IMvxNavigationService navigationService) : base(logProvider, navigationService)
        {
        }
        ...
        private async Task LoginAsync()
        {
            ...
            try
            {
                ...
                if (this.DataService.MustSynchronize())
                {
